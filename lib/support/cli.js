...
function validateInput(argv) {
  ...
  // if (
  //   argv.connectivity.profile !== 'native' &&
  //   argv.connectivity.engine === 'tc'
  // ) {
  ...
  // if (
  //   argv.connectivity.profile !== 'native' &&
  //   argv.connectivity.engine === 'tsproxy'
  // ) {
...
module.exports.parseCommandLine = function parseCommandLine() {
  let validated = yargs
    ...
    .option('firefox.nightly', {
      describe: 'Use Firefox Nightly. Will ovverride firefox.binaryPath',
      type: 'boolean',
      group: 'firefox'
    })
